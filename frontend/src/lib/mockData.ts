import { Table, MenuItem, Booking, Invoice, InventoryItem, Supplier, Promotion, Customer, Reward, PointHistory, VoucherHistory } from '../types';

// Mock Tables
export const mockTables: Table[] = [
  { id: '1', number: 'T01', area: 'Main Hall', seats: 4, status: 'free', floor: 'Floor 1' },
  { id: '2', number: 'T02', area: 'Main Hall', seats: 4, status: 'occupied', floor: 'Floor 1' },
  { id: '3', number: 'T03', area: 'Main Hall', seats: 2, status: 'free', floor: 'Floor 1' },
  { id: '4', number: 'T04', area: 'VIP', seats: 6, status: 'reserved', floor: 'Floor 2' },
  { id: '5', number: 'T05', area: 'VIP', seats: 8, status: 'free', floor: 'Floor 2' },
  { id: '6', number: 'T06', area: 'Main Hall', seats: 4, status: 'dirty', floor: 'Floor 1' },
  { id: '7', number: 'T07', area: 'Outdoor', seats: 4, status: 'free', floor: 'Floor 1' },
  { id: '8', number: 'T08', area: 'Outdoor', seats: 2, status: 'broken', floor: 'Floor 1' },
];

        ...
        <div className="h-16 flex items-center justify-between px-4 border-b">
          {sidebarOpen && (
            <div className="flex items-center gap-2">
              ...
              <span className="text-lg text-[#10B981]">Restaurant</span>
            </div>
          )}
          <button
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#10B981] w-64"
              />
            </div>

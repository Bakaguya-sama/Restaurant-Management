...
router.get('/reservation/:reservationId', (req, res) => reservationDetailController.getDetailsByReservationId(req, res));
router.get('/table/:tableId', (req, res) => reservationDetailController.getDetailsByTableId(req, res));

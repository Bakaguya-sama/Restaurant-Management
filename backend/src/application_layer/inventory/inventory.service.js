...
async function listExports({
  ...
  const repo = require("../../infrastructure_layer/inventory/inventory.repository");
  const exports = await repo.getExports({ start_date, end_date, search });
  ...
  return exports.map((e) => ({
    ...
    reason: e.notes,
    staffName: e.staff ? e.staff.full_name : null,
    items: e.details || [],
  }));
}
